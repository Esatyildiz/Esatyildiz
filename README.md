...
🎨 **Front-End & UI/UX:** Crafting clean layouts with HTML5, CSS3, SCSS, Tailwind CSS, Bootstrap, JavaScript, React, and Next.js.  
⚙️ **Backend & Database:** Managing dynamic operations with PHP, Classic ASP, MSSQL, and MySQL.  
🤖 **AI & Prompt Engineering:** Integrating AI workflows to accelerate development and optimize code delivery.  
📫 **Open to collaborations and freelance work.** Feel free to reach out below!  
